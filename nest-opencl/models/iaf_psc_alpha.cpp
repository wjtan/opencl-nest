...
iaf_psc_alpha::handle( SpikeEvent& e )
{
  ...
  //if (this->get_gid() <= 2)
    // {
      // std::cout << e.get_sender_gid() << " " << this->get_gid() << " " << e.get_weight() << " " << e.get_multiplicity() << " " << s << " " << e.get_rel_delivery_steps(kernel().simulation_manager.get_slice_origin() ) << std::endl;
      // getchar();
    // }
  ...
  {
    // std::cout << e.get_sender_gid() << " " << this->get_gid() << " " << this->get_lid() << " " << e.get_weight() << " " << e.get_multiplicity() << " " << s << " " << e.get_rel_delivery_steps(kernel().simulation_manager.get_slice_origin() ) << std::endl;
